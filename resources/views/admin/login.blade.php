                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-lg-block bg-login-image">
                            <img class="img-fluid m-5" style="width: 25rem;" src="/template/img/undraw_dog.jpeg" alt="...">
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                @if ($errors->count())
                                <div class="alert-alert-danger"> <!-- Doğru şekilde açın -->
                                    <ul>
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="{{route('admin.sifremi-unuttum')}}">Parolamı Unuttum</a>
                                </div>
                                <div class="text-center">
